...
class URMPC:
    ...
    def compute_control(self, 
        ...
        try:
            ...
            # ---- NEW: cache Jacobian of the current configuration
            self._J_cached = self.dynamics.get_jacobian(current_joint_state['position']).copy()
    ...
    def calculate_stage_cost(self, state, target_ee_pose, base_state, control, k):
        ...
        # --- Use cached J instead of an expensive MoveIt call ---
        J = self._J_cached
        J_pos, J_ori = J[:3, :], J[3:, :]
